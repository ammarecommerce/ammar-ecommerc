      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
        {SERVICES.map((s, i) => (
          <div
            ...
            className="ae-card rounded-xl p-7 flex flex-col justify-between hover:shadow-lg transition-all duration-300 cursor-pointer border border-transparent hover:border-orange-200 group"
          >
            <div>
