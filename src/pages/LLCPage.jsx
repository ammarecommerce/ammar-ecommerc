          ...
          <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 space-y-4">
            ...
            <div className="pt-2">
              <a
                ...
                className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 rounded-xl transition-all inline-flex items-center justify-center gap-3 text-sm shadow-md px-2"
              >
