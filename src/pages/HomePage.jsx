...
const HomePage = ({ setPage }) => (
  <PageShell>
    ...
    <section className="mt-10 grid md:grid-cols-2 gap-12 items-center">
      <FadeIn direction="right" delay={0.1} className="order-2 md:order-1">
        <FounderPhoto className="w-full aspect-square md:aspect-[4/5]" />
      </FadeIn>
        ...
        {SERVICES.slice(0, 6).map((s, i) => (
          <FadeIn key={i} direction="up" delay={0.1 * (i + 1)}>
            <div
              ...
              className="ae-card rounded-xl p-6 flex flex-col justify-between hover:shadow-md transition-all duration-300 cursor-pointer group h-full"
            >
              <div>
    ...
    <section className="mt-10">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {CASE_STUDIES.map((c, i) => (
          <FadeIn key={i} direction="up" delay={0.1 * (i + 1)}>
            <div className="ae-card rounded-xl p-6 h-full">
    ...
    <section className="mt-10">
      <FadeIn direction="up" delay={0.1}>
        ...
        <p className="ae-text-steel max-w-2xl mb-10">
          Client feedback and testimonials from business owners.
        </p>
      </FadeIn>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {TESTIMONIALS.map((t, i) => (
          <FadeIn key={i} direction="up" delay={0.1 * (i + 1)}>
            <div className="ae-card rounded-xl p-6 flex flex-col h-full">
    ...
    <section className="mt-10">
      ...
      <div className="space-y-4 max-w-3xl">
        {FAQS.map((f, i) => (
          <FadeIn key={i} direction="up" delay={0.05 * (i + 1)}>
            <FAQItem q={f.q} a={f.a} />
          </FadeIn>
        ))}
      </div>
